...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thermostat.last_scheduled_setpoint'
        db.add_column('climatecontrol_thermostat', 'last_scheduled_setpoint', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='thermostat_scheduled_setpoint', null=True, to=orm['climatecontrol.ScheduledHoldSetpoint']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thermostat.last_scheduled_setpoint'
        db.delete_column('climatecontrol_thermostat', 'last_scheduled_setpoint_id')
