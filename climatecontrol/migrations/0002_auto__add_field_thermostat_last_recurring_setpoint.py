...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thermostat.last_recurring_setpoint'
        db.add_column('climatecontrol_thermostat', 'last_recurring_setpoint', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='thermostat_related', null=True, to=orm['climatecontrol.RecurringWeeklySetpoint']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thermostat.last_recurring_setpoint'
        db.delete_column('climatecontrol_thermostat', 'last_recurring_setpoint_id')
    ...
    models = {
        ...
        'climatecontrol.thermostat': {
            ...
            'last_recurring_setpoint': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'thermostat_related'", 'null': 'True', 'to': "orm['climatecontrol.RecurringWeeklySetpoint']"})
        },
