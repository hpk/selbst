...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('climatecontrol_weatherlocation', (
        ...
        db.send_create_signal('climatecontrol', ['WeatherLocation'])


    def backwards(self, orm):
        
        # Deleting model 'WeatherLocation'
        db.delete_table('climatecontrol_weatherlocation')
    ...
    models = {
        ...
        'climatecontrol.weatherlocation': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'WeatherLocation', '_ormbases': ['core.Sensor']},
